        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
          <div className="rounded-2xl border border-sky-600 p-6 shadow-md ring-1 ring-sky-600 sm:order-last sm:px-8 lg:p-12">
            <div className="text-center">
              <h2 className="text-lg font-medium text-zinc-500 dark:text-zinc-100">
                17/08/2024
                <span className="sr-only">Data</span>
              </h2>

              <p className="mt-2 sm:mt-4">
                <strong className="text-3xl font-bold text-zinc-500 dark:text-zinc-100 sm:text-4xl">
                  Culto do Novo viver
                </strong>
              </p>
            </div>
